package com.ibm.cloud.empevents;
...
public class EmployeeApplication {
	...
	public Docket swaggerApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
					.apis(RequestHandlerSelectors.basePackage("com.ibm.cloud.empevents.controller"))
					.paths(PathSelectors.any())
				.build()
				.apiInfo(new ApiInfoBuilder().version(version).title("Employee Events API").description("Documentation Employee Events API v" + version).build());
	}
